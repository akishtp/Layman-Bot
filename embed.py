...
def discover_help_embed(ctx):
  ...
  embed.add_field(name="Genre",value="movie :"+" ".join(movie_category[0])+"\ntv :"+" ".join(tv_category[0]),inline=False)
  embed.add_field(name="Sort-By",value="popularity, release_date, revenue, title, rating")
